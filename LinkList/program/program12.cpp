...
from user and concat source linked list after destination linked list.
Function Prototype :
...
int concateList(struct node** srcHead, struct node** destHead) {
...
int main() {
	...
	//call concta fun
	int status = concateList(&srcHead, &destHead); 
	if(status == 0)  {
